      ...
      <section class="page-main__user-content user-content">
        ...
        <article class="user-content__post post">
          ...
          <div class="post__content">
            ...
            <img class="post__img" src="img/post-img.jpg" alt="post" />
          </div>
        ...
        <article class="user-content__post post">
          ...
          <div class="post__content">
            <p class="post__text">
              ...
              right typography scale to naming and organizing your text styles.
            </p>
          </div>
          <div class="post__likes">
            <svg class="post__likes-icon" width="16" height="16">
        ...
        <div class="right-sidebar__stories stories">
          ...
          <div class="stories__add">
            ...
            <div class="stories__add-box">
              <a href="#d" class="stories__add-link">
                Add to your story
              </a>
              <p class="stories__add-text">
          ...
          <ul class="stories__list">
            <li class="stories__item">
              ...
              <div class="stories__item-box">
                <a href="#e" class="stories__item-link">
                  Concuria
                </a>
